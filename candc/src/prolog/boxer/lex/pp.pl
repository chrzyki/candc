...
semlex(pp,Sym,Index,Att-[sem:'REL'|Att],Sem):- !,
...
semlex(pp/n,Sym,Index,Att-[sem:'REL'|Att],Sem):- !,
...
semlex(pp/s:_,Sym,Index,Att-[sem:'REL'|Att],Sem):- !,
   Sem = lam(S,lam(E,app(S,lam(X,B:drs([],[B:Index:rel(E,X,Sym,0)]))))).

semlex(pp/s,Sym,Index,Att-[sem:'REL'|Att],Sem):- !,
   Sem = lam(S,lam(E,app(S,lam(X,B:drs([],[B:Index:rel(E,X,Sym,0)]))))).
